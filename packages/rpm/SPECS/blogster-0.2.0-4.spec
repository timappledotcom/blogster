...
# Install icon files
cp icons/blogster-16.png $RPM_BUILD_ROOT/usr/share/icons/hicolor/16x16/apps/blogster.png
cp icons/blogster-22.png $RPM_BUILD_ROOT/usr/share/icons/hicolor/22x22/apps/blogster.png
cp icons/blogster-24.png $RPM_BUILD_ROOT/usr/share/icons/hicolor/24x24/apps/blogster.png
cp icons/blogster-32.png $RPM_BUILD_ROOT/usr/share/icons/hicolor/32x32/apps/blogster.png
...
cp icons/blogster-48.png $RPM_BUILD_ROOT/usr/share/pixmaps/blogster.png
...
Exec=blogster %F
Terminal=false
Categories=Office;TextEditor;WordProcessor;
...
/usr/share/pixmaps/blogster.png
...
%changelog
* Fri Jul 25 2025 Tim Parkin <tim@parzzix.net> - 0.2.0-4
- Enhanced icon installation with more sizes and pixmaps fallback
- Added post-install scripts to update icon and desktop caches
- Improved desktop entry with better metadata
- Fixed dock icon display issues
